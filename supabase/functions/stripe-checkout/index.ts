...
Deno.serve(async (req) => {
  ...
  // Authenticated Supabase client (as the calling user)
  ...
  // Create a pending purchase row first so we have an ID for Stripe metadata
  ...
  // Derive origin for redirect URLs
    ...
    line_items: [
      {
        price_data: {
          ...
          product_data: {
            name: listing.title,
            description: `${count.toLocaleString()} records`,
          },
